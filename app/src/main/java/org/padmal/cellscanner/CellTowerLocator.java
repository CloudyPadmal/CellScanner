...
/**
 * Created by padmal on 9/27/17.
 */

public class CellTowerLocator extends PhoneStateListener {

    Context mContext;
    public static String LOG_TAG = "Padmal";

    public CellTowerLocator(Context context) {
        mContext = context;
    }
